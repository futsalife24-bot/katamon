...
- `gear_lab_control_frame_01`: CATAMON LAB内のボタン・タブ・小型プレートへ共通利用する9-sliceメカフレーム。文字と状態色はDOM/CSSで合成する。
...
- Lab control frame prompt: one transparent square 9-slice control frame; blackened gunmetal, aged brass, compact rivets and restrained cyan instrument glass; no text, background, character or separate variants.
