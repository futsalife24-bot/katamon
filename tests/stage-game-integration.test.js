...
test('game integration isolates official stages while online custom starts are identity-gated', () => {
  ...
  assert.match(html, /url\("assets\/title-shield-button\.webp"\)/);
  assert.match(html, /url\("assets\/title-parchment-button\.webp"\)/);
  ...
  assert.match(html, /v2\.0\.87-exit-confirm-friendly-ui/);
  ...
  assert.match(serviceWorker, /katamon-pwa-v2\.0\.87-exit-confirm-friendly-ui/);
  assert.match(serviceWorker, /assets\/title-mode-board\.webp/);
  assert.match(serviceWorker, /assets\/title-shield-button\.webp/);
  assert.match(serviceWorker, /assets\/title-parchment-button\.webp/);
