...
(async () => {
  ...
  check('battle HUD crops transparent asset margins and uses measured content anchors',
    ...
    && anchoredHudSource.includes("const BUILD_ID = 'v2.0.69-first-battle-media-debuff-hud';"));
  ...
  check('battle HUD reserves the centered round wind console and keeps the stage title layer clear',
    ...
    && hudSource.includes("const BUILD_ID = 'v2.0.69-first-battle-media-debuff-hud';"));
  const app = kt();
  const h = app.stage3();
