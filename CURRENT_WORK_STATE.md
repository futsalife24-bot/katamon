...
## v171 キャラ選択の見出し強調・中断再開ギア（作業中）

- 作業ブランチ: `feat/v171-select-resume-gear`。公開済みv170（PR #115）のキャラ選択画面だけを、メロニキの指示に合わせて整える。ゲーム内容、キャラ性能、ほかの画面、オンライン通信、勝敗処理、Firebaseルールは変更しない。
