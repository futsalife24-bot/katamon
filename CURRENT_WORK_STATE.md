...
## v172 終了確認を吊り看板・レバーへ変更（作業中）

- 作業ブランチ: `feat/v172-exit-dialog-wood`。公開済みv171（PR #116）の端末戻る時に出す終了確認だけを、木板とレバーの意匠へ作り替える。戻る履歴、CloseWatcher、ゲーム内容、キャラ、オンライン通信、勝敗処理、Firebaseルールは変更しない。
