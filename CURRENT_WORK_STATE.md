...
- ブランチ: `master`
- 作業中ブランチ: `perf/v132-title-art`（v132。メロニキ承認前のためmasterへは未マージ）
...
- 現在の進行: **公開版はv131。v132「タイトル画面を焼く」は実装・検証完了、PR準備中。**
...
> ⏳ **実装・検証完了、PR準備中。** 公開版はまだv131。ルール変更・Console作業は不要。
...
15. **軽量化（4版に分ける）** — ユーザー要望・2026-08-05。実機で「動作が重い」。
    ...
    - ~~v132 タイトル画面を焼く~~ — 実装・検証完了、PR準備中。2倍解像度で1枚に焼き、
