...
- ブランチ: `master`
- 作業中ブランチ: `claude/katamon-handoff-avsydw`（v126 チュートリアル。未公開）
- 現行ビルド: `v126`（チュートリアル「あそび方」。未公開／ルール変更なし）
- 直前の公開ビルド: `v125`（1vs1の胴体の空きに情報／元素材の削除。PR #50）
...
15. **Issue #4 オンラインHPバーの瞬間的なずれ** — 未着手。
