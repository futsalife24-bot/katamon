...
- ブランチ: `master`
- 作業中ブランチ: `feat/v134-character-select-abilities`（PR作成前。メロニキ承認前にマージしない）
...
- 現在の進行: **v133「次の風予報」まで公開済み。v134「キャラクター選択を必殺技だけに整理」は作業中・未公開。**
  v134候補は追加6件を含む合計 **1131件成功**。PRを作り、メロニキ承認待ちで止める。
...
> ⏳ **未公開**（作業ブランチ `feat/v134-character-select-abilities`）。ルール変更・Console作業は不要。
...
17. **v134 キャラクター選択を必殺技だけに整理** — メロニキの指示で差し込み。作業中・未公開。
