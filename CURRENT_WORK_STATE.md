...
## v177 VSを前面へ戻し砲弾カードを離す（PR作成前）

- 作業ブランチ: `fix/v177-vs-card-spacing`。v176で背景へ移したVS紋章の勢いが弱く見えるため、VSをカードより前面へ戻す。その代わり、上の自陣営カードを左上、下の相手陣営カードを右下へ少し離し、2vs2でも4人の顔・名前を読み取れる余白を作る。
