...
## v164 部屋内のモンスター選択にキャラ画像を表示（実装済み・PR準備中）

- 作業ブランチ: `feat/v164-lobby-monster-images`。公開済みv163（PR #106）から、メロニキの「部屋内のモンスター選択でもキャラ画像を見たい」という要望だけを扱う。
...
42. **v164 部屋内のモンスター選択にキャラ画像を表示** — 実装済み・PR準備中。
