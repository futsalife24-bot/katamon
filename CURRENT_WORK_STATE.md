...
- ブランチ: `master`
- 作業中ブランチ: `feat/v133-wind-forecast`（PR作成前。メロニキ承認前にマージしない）
...
- 現在の進行: **v132「タイトル画面を焼く」まで公開済み。v133「次の風予報」は作業中・未公開。**
  v133候補は追加27件を含む合計 **1125件成功**。PRを作り、メロニキ承認待ちで止める。
...
> ⏳ **未公開**（作業ブランチ `feat/v133-wind-forecast`）。ルール変更・Console作業は不要。
...
16. **v133 次の風予報** — メロニキの指示で最優先へ繰り上げ。作業中・未公開。
