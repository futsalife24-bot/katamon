...
## v166 終了確認1回でカタモンを抜ける（公開前・PR #109）

- 作業ブランチ: `fix/v166-single-exit`。公開済みv165（PR #108）で終了確認の前に画面が横へ往復する問題を直した後、メロニキから「アプリを閉じるを選んでも3〜4回繰り返さないと終わらない」と実機報告があり、その終了回数だけを扱うPR #109を作成した。
...
44. **v166 終了確認1回でカタモンを抜ける** — 公開前（PR #109）。
