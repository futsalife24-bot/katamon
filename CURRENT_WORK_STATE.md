...
- ブランチ: `master`
- 作業中ブランチ: `claude/katamon-handoff-avsydw`（v124 VSカットインの手直し。未公開）
- 現行ビルド: `v124`（VSカットインの顔の位置と砲弾の動き。未公開／ルール変更なし）
- 直前の公開ビルド: `v123`（VSカットインを砲弾ネームプレートへ。PR #48）
...
13. **Issue #4 オンラインHPバーの瞬間的なずれ** — 未着手。
