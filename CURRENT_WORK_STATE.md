...
## v157 大型ステージで縦に余白が出るカメラを修正（PR作成前）

- 作業ブランチ: `fix/v157-large-stage-camera`。v156公開後、メロニキの実機画面で大型ステージが「視点距離38%」のときに戦場全体が縦へ縮んで見えることを確認して着手した。
...
35. **v157 大型ステージで縦に余白が出るカメラを修正** — PR作成前。
   - 大型で保存済みの遠い視点を使っても、戦場の高さを超えて引かず、手番キャラを追う自然な視点にする。
36. Issue #5 対戦部屋内の戦績表示
...
38. **Issue #4 オンラインHPバーの瞬間的なずれ** — 未着手。
