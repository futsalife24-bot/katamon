...
- ブランチ: `master`
- 作業中ブランチ: `feat/v135-normal-shot-unification`（通常弾の性能統一。PR #61、レビュー待ち）
...
- 現在の進行: **v135「通常弾の性能統一」を実装・検証済み。PR #61、レビュー待ち。**
...
18. **v135 全キャラの通常弾を共通化** — メロニキの指示で差し込み。PR #61、レビュー待ち。
