...
## v152 演習条件画面の整理と2vs2追加キャラ選択（PR作成前）
...
- 実画面: この作業環境は接続可能な実ブラウザが0台。PRのモバイル実ブラウザ検査で画面遷移を確認し、公開候補はメロニキの実機で文字切れ・押しやすさを確認する。
...
34. **Issue #4 オンラインHPバーの瞬間的なずれ** — 未着手。
