...
- ブランチ: `master`
- 現行ビルド: `v104`（Issue #25 段B ＋ Issue #26 段C オンライン2vs2。master へマージ済み／Consoleルール反映済み）
...
- 現在の進行: 段B（Issue #25）と 段C（Issue #26）を v104 として公開。**4人ぶんの実機QAが未実施のまま残っている。** 次は 段D 切断・CPU引き継ぎ #8 (v105)。
