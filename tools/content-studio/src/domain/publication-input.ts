...
export function publicationInputKey(draft: DraftRecord): string {
  ...
  return stableStringify({
    ...
    originalSha256: draft.originalSha256, hitOriginalSha256: draft.hitOriginalSha256, editor, processingOperations: draft.processingOperations, landmarks: draft.landmarks, partDetection: draft.partDetection,
